import { LEVELS, SPECIALISATIONS, TIMES } from '../../constants/data';

export const QuestionnaireProperty = {
  UserId: {
    Description: {
  ...
  Specialisation: {
    Description: {
      ...
      isArray: true,
      example: [SPECIALISATIONS[1], SPECIALISATIONS[3]],
    },
    Validate: {
      Message: `Специализация должна быть набором из значений (${SPECIALISATIONS.join(', ')})`,
    },
  },
  Time: {
    Description: {
